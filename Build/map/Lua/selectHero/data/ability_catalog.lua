...
local presentation_by_rawcode = {
    ...
    A0N1 = {range = "250", cooldown = "12 / 11 / 10 秒"},
    A0N2 = {range = "冲锋 800；路径 180", cooldown = "15 / 13 / 11 秒"},
    A0N3 = {damage = "无直接伤害", range = "自身", cooldown = "被动"},
    A0N4 = {damage = "强化伤害由 Lua 结算", range = "自身", cooldown = "被动"},
